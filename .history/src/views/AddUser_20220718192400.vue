...
export default {
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      console.log("老时间戳:",Date.parse(this.ruleForm.date1));
      console.log("新时间戳:",Date.parse(new Date()));
      console.log("年龄为:",Math.trunc(Date.parse(new Date())-Date.parse(this.ruleForm.date1))%31536000);
      const that = this;
