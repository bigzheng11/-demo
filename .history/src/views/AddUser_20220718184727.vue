      ...
      return {
        ...
        rules: {
          ...
          username: [
            ...
            { min: 1, max: 9, message: '长度在 1 到 5 个字符', trigger: 'blur' }
          ],
          password: [
...
date1: [
    ...
    methods: {
      ...
      submitForm(formName) {
        ...
        console.log("date1",formName.data1);//ruleForm
//         const that=this
...
//             //↑拿到的表单数据
//             axios.post('http://localhost:8181/User/save',this.ruleForm).then(function (res) { 
//               if(res.data=="成功"){
//                 // alert("添加成功")
//                 that.open3()
